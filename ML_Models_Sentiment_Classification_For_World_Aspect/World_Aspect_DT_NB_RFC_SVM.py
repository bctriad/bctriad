#This code is used to Model Decision Tree, Random Forest, Naive Bayes and SVM for Sentiment Classification task on World Aspect.
#The code utilizes the dataset World_Aspect_Sentiment_Classification.json to train Decision Tree, Random Forest, Naive Bayes and SVM. 
...
def train_model(test_perc):
    ...
    #List used to dump the data from World_Aspect_Sentiment_Classification.json
    data = list()
    
    #Read World_Aspect_Sentiment_Classification.json dataset and store it in a list
    with open('World_Aspect_Sentiment_Classification.json' , 'r') as f:
